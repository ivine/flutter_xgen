 ...
 */
export class L10nPanel {
  public static currentPanel: L10nPanel | undefined;
  ...
  public static render(extensionUri: Uri) {
    if (false) {
      ...
      // L10nPanel.currentPanel._panel.reveal(ViewColumn.One);
    } else {
      ...
      L10nPanel.currentPanel = new L10nPanel(panel, extensionUri);
    }
  }
   ...
   */
  public dispose() {
    L10nPanel.currentPanel = undefined;
    ...
    return /*html*/ `
      ...
      <html lang="en">
        <head>
          ...
          <title>FXG L10n Datas</title>
        </head>
        <body>
          <h1>All L10n Datas</h1>
